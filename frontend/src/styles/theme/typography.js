...
export const createTypography = (customTheme, colors) => ({
  fontFamily: customTheme.fonts.main, // Verdana, Arial, sans-serif per Stockholm guidelines
  fontSize: 16, // Stockholm standard: Verdana 16px for body text
