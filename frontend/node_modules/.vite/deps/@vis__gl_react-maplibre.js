...
function _Map(props, ref) {
  ...
  (0, import_react3.useEffect)(() => {
    ...
    let isMounted = true;
    let maplibre;
    Promise.resolve(mapLib || import("./maplibre-gl.js")).then((module) => {
      if (!isMounted) {
        return;
      }
      if (!module) {
...
// node_modules/@vis.gl/react-maplibre/dist/index.js
...
//# sourceMappingURL=@vis__gl_react-maplibre.js.map
